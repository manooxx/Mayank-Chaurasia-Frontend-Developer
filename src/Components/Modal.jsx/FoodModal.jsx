...
const FoodModal = ({ id, setFlag }) => {
  ...
  return (
    <div className='foodModal'>
      ...
      <div className='md:w-2/5 rounded-2xl h-96 bg-white p-3'>
        <IoClose className='absolute right-96 cursor-pointer text-lg hover:scale-105 duration-100' onClick={handleClick} />
        {
          <img className='h-56 md:h-64 w-full rounded-2xl' src={idData.strMealThumb} alt="err" /> || <Skeleton />}
